 ...
 * @throws Error if invalid
 */
export function validateSearchText(text: string): string {
 ...
 * @throws Error if invalid
 */
export function validateDateFilter(date: string): string {
 ...
 * @throws Error if invalid
 */
export function validateTitleFilter(title: string): string {
